...
function shortcode_adverts_list( $atts ) {
    ...
    ob_start();
    include_once adverts_return_template_pat('list.php');
    return ob_get_clean();
}
...
function shortcode_adverts_add( $atts ) {
    ...
    if($action == "") {
        ...
        ob_start();     
        include_once adverts_get_tplpath('add.php');
        ...
        if($valid) {
            ...
            ob_start();
            include_once adverts_get_tplpath('add-preview.php');
            $content = ob_get_clean();
        ...
        ob_start();
        include_once adverts_get_tplpath('add-save.php');
        $content = ob_get_clean();
...
function _adverts_manage_list( $atts ) {
    ...
    include_once adverts_get_tplpath('manage.php');
} 
...
function _adverts_manage_edit( $atts ) {
    ...
    include_once adverts_get_tplpath('manage-edit.php');
}
...
function shortcode_adverts_categories( $atts ) {
    ...
    include_once adverts_get_tplpath('categories-'.$show.'.php');
    return ob_get_clean();
}
 ...
 */
function adverts_get_tplpath($file) {	
    if( file_exists( get_template_directory() . '/wpadverts/templates/' . $file ) === FALSE ) {
     	return ADVERTS_PATH . 'templates/' . $file;
    } else {
      	return get_template_directory() . '/wpadverts/templates/' . $file;
    }
}
